...
from batch.inference.types import BatchInfer, ModelFeatures, ModelOutputs, stack_features, unstack_features, stack_outputs, unstack_outputs
...
class BatchProcessor:
    ...
    def __call__(self, *args, **kwargs) -> ModelOutputs:
        ...
        return asyncio.run_coroutine_threadsafe(
            self._schedule(features), self._loop
        ).result()
